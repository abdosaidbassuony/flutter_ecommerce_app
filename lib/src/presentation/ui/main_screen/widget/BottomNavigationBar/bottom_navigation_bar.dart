...
import 'package:ecomarce_app/src/presentation/ui/main_screen/widget/BottomNavigationBar/bottom_curved_Painter.dart';
import 'package:flutter/material.dart';

class CustomBottomNavigationBar extends StatefulWidget {
  final Function(int)? onIconPressedCallback;

  const CustomBottomNavigationBar({Key? key, this.onIconPressedCallback})
      : super(key: key);

  @override
  createState() => _CustomBottomNavigationBarState();
}
